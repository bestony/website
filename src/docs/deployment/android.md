...
If you have an existing keystore, skip to the next step. If not, create one by
...
{{site.alert.note}} Obfuscation and minification can considerably extend compile
